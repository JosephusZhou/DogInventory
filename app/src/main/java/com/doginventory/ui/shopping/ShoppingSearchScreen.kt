...
fun ShoppingSearchScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            ShoppingListContent(
                pendingItems = searchState.pendingItems,
                doneItems = searchState.doneItems,
                showDone = showDone,
                bottomPadding = 24.dp,
                ...
                emptyContent = {
                    ShoppingSearchEmptyState(hasQuery = searchState.query.isNotBlank())
                }
            )
        }
    }
...
@Composable
private fun ShoppingSearchTopBar(
    query: String,
...
@Composable
private fun ShoppingSearchEmptyState(hasQuery: Boolean) {
    Box(
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            Text(
                text = if (hasQuery) {
                    stringResource(R.string.shopping_search_empty_title)
                } else {
            ...
            Text(
                text = if (hasQuery) {
                    stringResource(R.string.shopping_search_empty_body)
                } else {
